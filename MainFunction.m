...
% This version incorporate the cost parameter from LMCO
...
%tic
% Global 
global X L Xf C1 C2 C3 Cws Cwc N M Cs delta_t xlower xupper xdelt;
...
L = 2;  % Lead time(settle down regarding the real case )
xdelt= 0.005; %0.005
...
%   - maintenance cost Cm for spindle  = 25000$
%   - maintenace cost Cm for ballscrew = 10000$
%   - maintenance cost Cm for a barrel of Coolant concentrate = $1500.00
Cm = 25000; % maintenance cost;
C1 = Cm; % Maintenance cost for type 1 / 15
C2 = Cm; % Maintenance cost for type 2  / 20
C3 = Cm; % Maintenance cost for type 3  /40
Cws = 1; % Cost of inventory per day  / 1
Cwc = 1000; % Cost of machine breakdown per day /1000
Cs = 1000; % Shipping cost
% Set shipping cost Cs
...
Xo=xbestDisc(1); %0.7826
Xm=xbestDisc(2);%0.9576
