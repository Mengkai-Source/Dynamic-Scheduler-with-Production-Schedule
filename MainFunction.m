...
L = 8;  % Lead time(settle down regarding the real case )
xdelt= 0.005; %0.005
...
switch Cm
    ...
    case 10000   %  ballscrew
        if L >= 7 && L < 14
            Cs = 250;
        elseif L < 7
            Cs = 500;
        end 
    otherwise    %  a barrel of Coolant concentrate
        if L >= 7 && L < 14
            Cs = 10;
        elseif L < 7
            Cs = 10;
