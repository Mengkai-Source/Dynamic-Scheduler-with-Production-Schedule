...
load('Sample_Data 04.25.mat'); %Import the sample data from PDX
...
Cws = 1; % Cost of inventory per unit time  %%% original 1
Cwc = 1000; % Cost of machine breakdown per unit time 10 %%% original 1000
